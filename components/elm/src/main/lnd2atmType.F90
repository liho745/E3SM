module lnd2atmType
  ...
  type, public :: lnd2atm_type
     ...
     real(r8), pointer :: qflx_rofliq_qsur_poc_grc(:) => null()
	 real(r8), pointer :: qflx_rofliq_qsub_poc_grc(:) => null() 	 
...
contains
  ...
  subroutine InitAllocate(this, bounds)
    ...
    allocate(this%qflx_rofliq_qsur_poc_grc(begg:endg))          ; this%qflx_rofliq_qsur_doc_grc(:) = ival
    ...
    allocate(this%qflx_rofliq_qsub_poc_grc(begg:endg))          ; this%qflx_rofliq_qsub_doc_grc(:) = ival
